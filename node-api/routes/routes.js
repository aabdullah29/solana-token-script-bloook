...
router.post("/mint/tokens", controller.mintTheTokens);
router.post("/burn/tokens", controller.burnTheTokens);
router.get("/token/supply", controller.supplyOfToken);
router.post("/just/transfer/tokens", controller.justTransferTheTokens);
